...
#### > Also I'll be creating another SPA "Fun-Box", where you'll be playing with machine learning AI or finding some secrets in the terminal styled page! (At least that's my plan)(it's code will be private... sorry)
